        ...
        if (w<740) {
           ...
           $(".progress_side").css("position", "absolute");
           $(".progress_side").css("top", "50px");
           $(".progress_side").css("right", "-180px");
                	...
                	{  
                		...
                		if (position==="first" ) 
                         ...
                         var civilite_associe = getUrlParameter('civilite_associe');
                			   ...
                			   var situation_familiale_associe = getUrlParameter('situation_familiale_associe').replace(/\+/g, ' ');
                			   ...
                			   localStorage.setItem("situation_familiale_associe", situation_familiale_associe);
                        ...
                        var nom_commercial = getUrlParameter('nom_commercial').replace(/\+/g, ' ');
                        var enseigne = getUrlParameter('enseigne').replace(/\+/g, ' ');
                        var sigle = getUrlParameter('sigle').replace(/\+/g, ' ');
                         
                         if (nom_societe!=undefined && nom_societe!='') 
                          {
                            localStorage.setItem("nom_societe", nom_societe);
                            localStorage.setItem("nom_commercial", nom_commercial);
                        ...
                        if (getUrlParameter('activite_principal_societe')!=undefined && getUrlParameter('description_activite_principal_societe')!=undefined) 
                        {
                         ...
                         if (getUrlParameter('description_activite_principal_societe').replace(/\+/g, ' ')!='' && getUrlParameter('activite_principal_societe').replace(/\+/g, ' ')!='Choisissez votre activité principale dans cette liste') 
                                   {  
