            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            <li><a href="{{ route('login') }}"><i class="fa fa-sign-in" style="margin-right: 5px;" aria-hidden="true"></i>Login</a></li>
                            <li><a href="{{ route('register') }}"><i class="fa fa-registered" style="margin-right: 5px;" aria-hidden="true"></i>Register</a></li>
                        @else
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="{{ route('logout') }}"
                                            ...
                                            <i class="fa fa-sign-out" style="margin-right: 5px;" aria-hidden="true"></i>Logout
                                        </a>
