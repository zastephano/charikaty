                ...
                <div class="col-xs-12">
                    ...
                    <ol class="breadcrumb">
                        <li>
                            ...
                            <a href="index.php">Accueil</a> <a href="#">Certificat Négatif</a>
                        </li>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover no-mb" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <th>Denomination 1</th>
                                            <th>Denomination 2</th>
                                            <th>Denomination 3</th>
                                            <th>Benificiare</th>
                                     ...
                                     <td >
                         <div class="buttons">
                              <a  class="btn btn-success" href="valide.php">Accepté</a>
                              <button class="btn btn-danger" href="refuse.php">refusé</button>
                         </div> 
                     </td>
                                        </tr>
